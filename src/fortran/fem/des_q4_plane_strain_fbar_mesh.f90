...
contains
  ...
  subroutine assemble_q4_plane_strain_fbar_mesh( &
      ...
      min_j, min_j_bar, max_j_bar, integration_results)
    ...
    integer :: e, g, a, b, i, k, lrow, lcol, grow, gcol, result_index
    ...
    if (present(integration_results)) then
      call initialize_q4_integration_results(integration_results, nelem)
    end if
    ...
    do e = 1,nelem
      ...
      if (present(integration_results)) then
        call evaluate_q4_plane_strain_fbar_element( &
            ...
            element_min_j, element_j_bar, element_results)
